...
//	public static TestfileException InvalidCharacter(int lineNumber, String line) {
//		return new TestfileException("Ungültiges Zeichen: Zeile " + lineNumber + ": " + line);
//	}
	...
	public static TestfileException InvalidKeyword(int lineNumber, String strKeyword){
		return new TestfileException(PREFIX + "Ungültige Zeichen im Schlüsselwort: Zeile " + lineNumber + ": " + strKeyword);
	}
	
	public static TestfileException InvalidKeywordArgument(int lineNumber, int argNumber, String keywordArgs){
		return new TestfileException(PREFIX + "Ungültige Zeichen im Argument: Zeile " + lineNumber + ": Argument " + argNumber + ": " + keywordArgs);
	}

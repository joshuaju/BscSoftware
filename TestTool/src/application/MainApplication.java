...
//	}
	...
	public void start(Stage primaryStage) throws Exception {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("ui/fxml/TestDesignerMainView.fxml"));
	...
	public static void testExecution() throws IOException, ClassNotFoundException, KeywordLibraryException, TestfileSyntaxException{
